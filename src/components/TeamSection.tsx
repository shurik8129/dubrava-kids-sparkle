...
const TeamSection = () => {
  const teamMembers = [
    ...
    },
    {
      ...
      specialty: "Логопедия, дизартрия, алалия",
      education: "Учитель географии и биологии, логопед",
      image: "👩‍🎓",
      description: "В 1998 году окончила Бийский педагогический институт по специальности 'учитель географии и биологии'. Несмотря на опыт работы экономистом, поняла, что хочет работать с детьми и развиваться в логопедии. В 2018-2019 году получила квалификацию логопеда. Десять лет работала логопедом в частных центрах и детских садах.",
      tasks: [
        "Неправильное произношение звуков, слов и слогов",
        "Изменение темпа речи (ускорение или замедление)",
        "Отсутствие речи (запуск речи)",
      ...
      additionalInfo: "Постоянно развивается в профессии: прошла обучение в ФГБНУ 'Научный центр психического здоровья', множество семинаров по дизартрии, алалии, дисграфии, миофункциональной коррекции. Специализируется на работе с неговорящими детьми и смешанными формами дизартрии."
    }
  ];
      ...
      <div className="container mx-auto container-padding">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="text-center">
            ...
            <div className="text-3xl font-heading font-bold text-secondary mb-2">9</div>
