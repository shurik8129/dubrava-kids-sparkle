...
const TeamSection = () => {
  const teamMembers = [
    ...
    },
    {
      ...
      specialty: "Запуск речи, коррекция поведения",
      education: "Филология и иностранный язык",
      image: "👩‍🏫",
      description: "В 2006 году окончила Бийский педагогический институт по специальности \"Филология и иностранный язык\". Три года отработала по специальности. Всегда привлекала деятельность, связанная с коррекционной педагогикой, очень любит детей. Когда появилась возможность начать работу как ABA-инструктор, с радостью сказала работе \"Да\".",
      tasks: [
        "Запуск речи",
        "Понимание обращённой речи",
        "Коррекция поведения",
        "Приобретение основных навыков визуального восприятия",
        "Различение и наименование",
        "Расширение словарного запаса"
      ],
      additionalInfo: "СУПЕР-СИЛА: видеть потенциал в каждом ребенке, улавливать и подкреплять самые минимальные признаки прогресса, поддерживать и относиться с любовью и пониманием к каждому ребенку и его родителям. На данный момент в работе 8 детей. За 2-3 месяца отличные результаты: взгляд в глаза, реакция на имя, расширение игрового репертуара, понимание обращённой речи, даже первые слова!"
    }
  ];
