...
const videos: Video[] = [
  {
    ...
    description: "Упражнения для пальчиков и кистей рук",
    thumbnail: "/placeholder.svg",
    videoUrl: "/videos/dev-1.mp4",
    duration: "7:30",
  },
  {
    id: "2",
    title: "Игры на внимание",
    description: "Развитие концентрации и памяти",
    thumbnail: "/placeholder.svg",
    videoUrl: "/videos/dev-2.mp4",
    duration: "9:00",
  },
  {
    id: "3",
      ...
      <section className="py-16 bg-gradient-to-b from-primary/10 to-background">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Упражнения для всестороннего развития ребёнка: моторика, внимание, память
          </p>
        </div>
      </section>
