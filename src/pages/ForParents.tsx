...
const videos: Video[] = [
  {
    id: "1",
    title: "Как заниматься дома",
    description: "Советы для родителей по организации занятий",
  ...
  {
    id: "2",
    title: "Режим дня ребёнка",
    description: "Рекомендации по распорядку дня",
    thumbnail: "/placeholder.svg",
    videoUrl: "/videos/parents-2.mp4",
    duration: "8:30",
  },
  {
    id: "3",
    title: "Игры для развития",
    description: "Простые игры, которые можно делать дома",
    thumbnail: "/placeholder.svg",
    videoUrl: "/videos/parents-3.mp4",
    duration: "15:20",
  },
];
      ...
      <section className="py-16 bg-gradient-to-b from-primary/10 to-background">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Полезные материалы и рекомендации для занятий с ребёнком дома
          </p>
        </div>
      </section>
